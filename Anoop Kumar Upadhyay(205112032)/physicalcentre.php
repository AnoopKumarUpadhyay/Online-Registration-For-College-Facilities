...
<body>
<table width="1278" height="316" border="1">
  <tr>
    <td width="1268" height="308" background="physicalcentre.jpg">&nbsp;</td>
  </tr>
</table>

<p align="center" class="style1">WELCOME TO REGISTRATION FOR PHYSICAL CENTRE: </p>
<form id="form1" name="form1" method="post" action="physicalcentre.php">
...
if($m_number==''){
echo "<script>alert('please Enter your m_number')</script>";
exit();
}
if($email=='')
{
...
{
$que="insert into physical_centre(name,roll_number,department,sex,m_number,email) values ('$name','$roll_number','$department','$sex','$m_number','$email')";
